...
projRoads_mst <- roads::projectRoads(landings,costRaster,existingRoadsRast,roadMethod='mst')
## isolate the new roads for plotting (TRUE for new road, NA elsewhere)
newroad_mst <- projRoads_mst$roads>0
newroad_mst[existingRoadsRast] <- NA
newroad_mst[!newroad_mst] <- NA
## (left) plot the cost raster and landings
par(mfrow=c(1,2))
plot(costRaster,col=rastColours,main='Cost')
points(landings,pch=19)  ## landings points
