...
**This function is deprecated please use `terra::distance` instead**
Here is an example of how to use `terra::distance` which is much faster than `getDistFromSource` was.
```{r terra-distance}
