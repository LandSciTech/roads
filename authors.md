...
- **Her Majesty the Queen in Right of Canada as represented by the
  ...
  Copyright holder for included functions buildSimList,
  getLandingsFromTarget, pathsToLines, plotRoads, projectRoads,
  rasterizeLine, rasterToLineSegments

- **Province of British Columbia**. Copyright holder.  
  Copyright holder for included functions getGraph, lcpList, mstList,
  shortestPaths, getClosestRoad, buildSnapRoads
